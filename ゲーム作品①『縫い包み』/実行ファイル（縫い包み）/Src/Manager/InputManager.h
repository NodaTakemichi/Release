...
public:
	//マウスのデフォルト座標
	static constexpr int MOUSE_DEFAULT_POS = 300;
	...
	//カーソルの状態変化
	void ChangeCurrsolMode(bool mode);
