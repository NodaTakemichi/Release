...
public:
	...
	// 角度
	static constexpr float ANGLE_90_RAD = 90.0f * DEG2RAD;
	static constexpr float ANGLE_180_RAD = 180.0f * DEG2RAD;
	static constexpr float ANGLE_270_RAD = 270.0f * DEG2RAD;
	...
	//文字列の長さを取得
	static int GetStringLength(const std::wstring& string, const int& fontHandle);
