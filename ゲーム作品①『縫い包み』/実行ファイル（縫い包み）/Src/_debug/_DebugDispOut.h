...
public:
	...
	void TRACE_S(int Color, std::wstring str, int num);
	void TRACE_S(int Color, std::wstring str, double num);
	void TRACE_S(int Color, std::wstring str, std::wstring str2);
